...
if (!options.sdkName || !options.platformName) {
    console.log(usage);
    process.exit(0);
}
...
function uploadData(data) {
    return new AWS.S3({region: 'us-east-1'}).putObject({
        ...
        Key: `raw/mobile_staging.codecoverage/${date.substring(0,10)}/mobile-staging-codecoverage-${process.env['CIRCLE_SHA1']}.json.gz`,
