...
int main(int argc, char *argv[]) {
    ...
    auto options = mbgl::MapOptions().withCachePath(cacheDB).withAssetPath(".").withAccessToken(std::string(token));
    auto fileSource = std::static_pointer_cast<mbgl::DefaultFileSource>(mbgl::FileSource::platformFileSource(options));
    if (!settings.online) {
